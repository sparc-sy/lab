...
موديول ESP32 مع كاميرا OV2640 مدمجة (2 MP، JPEG داخلي)، مناسب للمراقبة والبث والتصوير في مشاريع IoT.
...
| الكاميرا | OV2640 (2 MP, UXGA 1600×1200، خرج JPEG داخلي) |
| Flash | 4 MB (نموذجي) |
...
- رفع مثال **CameraWebServer** من Arduino ESP32 وحفظه على اللوحة، ثم الدخول عبر المتصفح لعرض الفيديو والتحكم بالدقة والإضاءة.
- التقاط لقطات دورية وإرسالها عبر HTTP أو MQTT إلى خادم (مراقبة غرفة، كشف حركة بسيط).
- بث فيديو منخفض الدقة للتعرف على الوجوه أو QR عند استخدام مكتبات مناسبة (مثل esp32-face).
